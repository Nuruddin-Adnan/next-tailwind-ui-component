...
const products = [
    { name: 'First Product', href: '#' },
    { name: 'Second Product', href: '#' },
                ...
                <>
                    <div className="mx-auto container  px-4">
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            <div className="flex flex-1 items-center justify-start lg:items-stretch lg:justify-end">
                                <div className="hidden lg:ml-6 lg:block">
                                    <div className="flex space-x-4">
                                        ...
                                        <Menu as="div" className="relative">
                                            <div>
                                                <Menu.Button className="text-gray-300 hover:bg-gray-700 hover:text-white flex items-center
                                                    rounded-md px-3 py-2 text-sm font-medium">
                                                    Product
                    ...
                    <Disclosure.Panel className="lg:hidden">
                        <div className="space-y-1 px-2 pb-3 pt-2">
                            ...
                            <>
                                <Disclosure.Button className="text-gray-300 hover:bg-gray-700 hover:text-white
